		...
		<div class="flex justify-center px-6 py-12">
			...
			<div class="w-full xl:w-3/4 lg:w-11/12 flex">
				...
				<div class="w-full lg:w-7/12 bg-white dark:bg-gray-700 p-5 rounded-lg lg:rounded-l-none">
					...
					<form class="px-8 pt-6 pb-8 mb-4 bg-white dark:bg-gray-800 rounded" action="/registar" method="POST">
							...
							<div class="md:ml-2">
                                ...
                                <div class="flex items-center mb-2">
                                    <input
                                        ...
                                        value="male"
                                    />
                                    <label class="text-sm text-gray-700 dark:text-white" for="male">
                                        Male
                                    </label>
                                </div>
                                <div class="flex items-center">
                                    <input
                                        ...
                                        value="female"
                                    />
                                    <label class="text-sm text-gray-700 dark:text-white" for="female">
                                        Female
                                    </label>
                                </div>
							</div>
